...
export const CATCH_MON_LINES = [
  ...
  },
  {
    ...
    eggEmoji: "🍃",
    stages: [
      { id: "budhoof", name: "BUDHOOF", Sprite: null, type: "GROVE", typeClr: "#88CC55", color: "#9BD46A", glow: "#B6F071", hp: 104, atk: 11, def: 14, evoLv: 12, desc: "Sprout fawn scout.\nGrass grows where its hooves tap." },
      { id: "thornhart", name: "THORNHART", Sprite: null, type: "GROVE", typeClr: "#88CC55", color: "#7CB84E", glow: "#D7FF7A", hp: 134, atk: 18, def: 20, evoLv: 25, desc: "Grove runner.\nIts antlers remember every forest trail." },
      { id: "eldercrown", name: "ELDERCROWN", Sprite: null, type: "GROVE", typeClr: "#88CC55", color: "#5F963F", glow: "#FFD870", hp: 168, atk: 24, def: 29, evoLv: null, desc: "Forest warden.\nA living canopy that protects tiny friends." },
    ],
  },
  {
    lineId: "flutterbug",
    ...
    eggEmoji: "🦋",
    stages: [
      { id: "nibblet", name: "NIBBLET", Sprite: null, type: "GLASS", typeClr: "#D6EE5A", color: "#BEEB5A", glow: "#F4FF7A", hp: 94, atk: 13, def: 9, evoLv: 12, desc: "Leaf muncher.\nIt nibbles letter-shaped bites from leaves." },
      { id: "glomoth", name: "GLOMOTH", Sprite: null, type: "GLASS", typeClr: "#D6EE5A", color: "#83D98A", glow: "#79F7FF", hp: 120, atk: 20, def: 14, evoLv: 25, desc: "Lantern cocoon.\nCorrect answers make its shell glow." },
      { id: "prismarip", name: "PRISMARIP", Sprite: null, type: "GLASS", typeClr: "#D6EE5A", color: "#52C6C9", glow: "#FFE36D", hp: 150, atk: 28, def: 20, evoLv: null, desc: "Glasswing dancer.\nIts colored shadows turn gloom into parade light." },
    ],
  },
  {
    lineId: "cactusaur",
    ...
    eggEmoji: "🌵",
    stages: [
      { id: "prickletot", name: "PRICKLETOT", Sprite: null, type: "OASIS", typeClr: "#6FD05E", color: "#74C95A", glow: "#F7B878", hp: 112, atk: 11, def: 15, evoLv: 12, desc: "Cactus dino toddler.\nIts tiny spines are softer than they look." },
      { id: "saguaromp", name: "SAGUAROMP", Sprite: null, type: "OASIS", typeClr: "#6FD05E", color: "#53AA4B", glow: "#FFC36B", hp: 144, atk: 18, def: 24, evoLv: 25, desc: "Desert stomper.\nEach step shakes hidden water awake." },
      { id: "oasisaur", name: "OASISAUR", Sprite: null, type: "OASIS", typeClr: "#6FD05E", color: "#3E8C42", glow: "#9FF7FF", hp: 182, atk: 23, def: 34, evoLv: null, desc: "Walking oasis.\nIt carries shade and fresh water for the team." },
    ],
  },
  {
    lineId: "frogspell",
    ...
    eggEmoji: "🐸",
    stages: [
      { id: "ribblet", name: "RIBBLET", Sprite: null, type: "RUNE", typeClr: "#66DDAA", color: "#65D89F", glow: "#A8FFE0", hp: 96, atk: 14, def: 11, evoLv: 14, desc: "Tadpole pupil.\nIt stores new words inside popping bubbles." },
      { id: "bogglyph", name: "BOGGLYPH", Sprite: null, type: "RUNE", typeClr: "#66DDAA", color: "#45B88E", glow: "#C8A0FF", hp: 124, atk: 22, def: 16, evoLv: 28, desc: "Rune hopper.\nIts belly glyphs flash before every spell." },
      { id: "chantoad", name: "CHANTOAD", Sprite: null, type: "RUNE", typeClr: "#66DDAA", color: "#348F76", glow: "#E4D2FF", hp: 154, atk: 30, def: 23, evoLv: null, desc: "Bubble archmage.\nIt traps attacks inside giant spell bubbles." },
    ],
  },
  {
    lineId: "ramcloud",
    ...
    eggEmoji: "🌩️",
    stages: [
      { id: "woolwisp", name: "WOOLWISP", Sprite: null, type: "STORM", typeClr: "#AACCFF", color: "#DDE8FF", glow: "#C7D8FF", hp: 100, atk: 14, def: 12, evoLv: 14, desc: "Breeze lamb.\nIt bounces higher whenever someone cheers." },
      { id: "galegrove", name: "GALEGROVE", Sprite: null, type: "STORM", typeClr: "#AACCFF", color: "#9CAFD6", glow: "#FFE25B", hp: 128, atk: 23, def: 17, evoLv: 28, desc: "Gust ram.\nIts hooves spin up little whirlwinds." },
      { id: "tempestag", name: "TEMPESTAG", Sprite: null, type: "STORM", typeClr: "#AACCFF", color: "#6C7FAE", glow: "#FFD94A", hp: 158, atk: 32, def: 24, evoLv: null, desc: "Storm charger.\nIt opens sunny paths through thunderclouds." },
    ],
  },
  {
    lineId: "crystowl",
    ...
    eggEmoji: "🦉",
    stages: [
      { id: "glimhoot", name: "GLIMHOOT", Sprite: null, type: "ORACLE", typeClr: "#C9A7FF", color: "#D8C8FF", glow: "#BDF7FF", hp: 100, atk: 15, def: 12, evoLv: 16, desc: "Crystal owl chick.\nIt blinks in memory patterns." },
      { id: "oracrix", name: "ORACRIX", Sprite: null, type: "ORACLE", typeClr: "#C9A7FF", color: "#A880D8", glow: "#E1FBFF", hp: 128, atk: 23, def: 18, evoLv: 30, desc: "Prism watcher.\nIt notices the answer before anyone speaks." },
      { id: "luminoracle", name: "LUMINORACLE", Sprite: null, type: "ORACLE", typeClr: "#C9A7FF", color: "#7650B0", glow: "#F7CFFF", hp: 160, atk: 31, def: 26, evoLv: null, desc: "Crystal oracle.\nIts silent feathers predict the next move." },
    ],
  },
];
...
const LINE_CONCEPT_MAP = {
  ...
  grovehart: "grovehart-line",
  flutterbug: "flutterbug-line",
  cactusaur: "cactusaur-line",
  frogspell: "frogspell-line",
  ramcloud: "ramcloud-line",
  crystowl: "crystowl-line",
};
...
export const EGG_DROP = {
  common: ["vocabmon", "flame", "wave", "leaf", "ice", "rock", "wind", "fairy", "sand", "dino", "coral", "cloud", "grovehart", "flutterbug", "cactusaur"],
  rare: ["bolt", "wind", "toxic", "metal", "flame", "wave", "ghost", "speed", "dream", "candy", "music", "dark", "mech", "frogspell", "ramcloud"],
  superrare: ["shadow", "psychic", "crystal", "dragon", "nature", "cosmic", "angel", "lava2", "crystowl"],
...
export function rollEggRarity({
  ...
  if (difficulty === "hell" && isBoss && isPerfect && totalStars >= 30 && roll < 0.015) {
    return "legendary";
  }
  const superRareChance =
    difficulty === "hell" ? 0.12 :
    difficulty === "hard" ? 0.08 :
    difficulty === "normal" && isPerfect ? 0.03 :
    0;
  if (roll < superRareChance) return "superrare";
  const rareChance =
    difficulty === "hell" ? 0.35 :
    difficulty === "hard" ? 0.30 :
    difficulty === "normal" ? 0.20 :
    0.12;
  if (roll < superRareChance + rareChance) return "rare";
  return "common";
}
